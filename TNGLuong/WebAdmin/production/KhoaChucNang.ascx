<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KhoaChucNang.ascx.cs" Inherits="TNGLuong.WebAdmin.production.KhoaChucNang" %>
<div class="x_panel">
    <div class="x_title">
        <h2>Kháo chức năng theo đơn vị</h2>
        ...
        <table style="width: 100%;">
            <tr>
                <td>                    
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Chức năng web<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                ...
                <td align="center">
                    ...
                    <div class="item form-group">
                        <div class="col-md-12 col-sm-12">
                            <asp:GridView ID="gvKhoaChucNang" runat="server" ShowFooter="False" AutoGenerateColumns="False" DataKeyNames="ID_KhoaChucNang" Width="100%"
                                BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnRowDeleting="gvKhoaChucNang_RowDeleting">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Chức năng web" SortExpression="TenChucNang">
                                        <HeaderStyle HorizontalAlign="Center"/>
                                        <ItemTemplate>
                                            <asp:Label ID="lblTenChucNang" Text='<%#Eval("TenChucNang") %>' runat="server" Width="100%"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                        
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="cmdDelete" runat="server" AlternateText="Xóa" CommandArgument='<%#Eval("ID_KhoaChucNang") %>' CommandName="Delete" ImageUrl="~/images/delete.png" Width="20px" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
